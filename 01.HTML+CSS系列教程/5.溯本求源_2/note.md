...
阿里巴巴矢量图标库：https://www.iconfont.cn。该网站包含大量的适量图形，如果使用纯色的图标，下载好之后，按照demo提示，使用font-face即可，如果使用彩色图标，还需要引入它的js文件，根据demo提示，使用symbol即可。

自定义字体图标：https://icomoon.io/app，在该网站上可以在线生成字体图标。
